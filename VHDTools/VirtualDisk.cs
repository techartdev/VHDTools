...
#pragma warning restore 0618
        ...
        {
            NativeMethods.RESIZE_VIRTUAL_DISK resize = new NativeMethods.RESIZE_VIRTUAL_DISK();
            resize.Version = NativeMethods.RESIZE_VIRTUAL_DISK_VERSION.RESIZE_VIRTUAL_DISK_VERSION_1;
            resize.Version1.NewSize = newSize;

            int res = NativeMethods.ResizeVirtualDisk(_handle, NativeMethods.RESIZE_VIRTUAL_DISK_FLAG.RESIZE_VIRTUAL_DISK_FLAG_NONE, ref resize, IntPtr.Zero);
        ...
        {
            NativeMethods.EXPAND_VIRTUAL_DISK_PARAMETERS expand = new NativeMethods.EXPAND_VIRTUAL_DISK_PARAMETERS();
            expand.Version = NativeMethods.EXPAND_VIRTUAL_DISK_VERSION.EXPAND_VIRTUAL_DISK_VERSION_1;
            expand.Version1.NewSize = newSize;
            
            int res = NativeMethods.ExpandVirtualDisk(_handle, NativeMethods.EXPAND_VIRTUAL_DISK_FLAG.EXPAND_VIRTUAL_DISK_FLAG_NONE, ref expand, IntPtr.Zero);
        ...
        private static class NativeMethods
        {
            ...
            public enum _EXPAND_VIRTUAL_DISK_FLAG
            {
            ...
            public struct EXPAND_VIRTUAL_DISK_PARAMETERS_Version1
            {
                ...
                /// </summary>
                public ulong NewSize; //ULONGLONG
            }
            ...
            [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
            public struct RESIZE_VIRTUAL_DISK
            {
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA5122:PInvokesShouldNotBeSafeCriticalFxCopRule", Justification = "Warning is bogus.")]
            ...
            /// <summary>
            /// Increases or decreases the size of a fixed or dynamic virtual hard disk (VHD). Windows 8 and upper!
            /// </summary>
            /// <param name="VirtualDiskHandle">A handle to the open VHD, which must have been opened using the VIRTUAL_DISK_ACCESS_METAOPS flag.</param>
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA5122:PInvokesShouldNotBeSafeCriticalFxCopRule", Justification = "Warning is bogus.")]
            [DllImport("virtdisk.dll", CharSet = CharSet.Unicode)]
            public static extern Int32 ResizeVirtualDisk(VirtualDiskSafeHandle VirtualDiskHandle, RESIZE_VIRTUAL_DISK_FLAG Flags, ref RESIZE_VIRTUAL_DISK Parameters, IntPtr Overlapped);
